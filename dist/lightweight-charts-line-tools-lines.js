...
import { LineToolPaneView, SegmentRenderer, TextRenderer, deepCopy, LineJoin, LineCap, BoxHorizontalAlignment, AnchorPoint, PaneCursorType, BoxVerticalAlignment, TextAlignment, LineEnd, BaseLineTool, merge, InteractionPhase, Point, getToolCullingState, OffScreenState, CompositeRenderer } from 'lightweight-charts-line-tools-core';
...
class LineToolTrendLine extends BaseLineTool {
    ...
    updateCullingState() {
         ...
         */
        const cullingState = getToolCullingState(points, this, options.line.extend);
        /**
...
class LineToolHorizontalLine extends BaseLineTool {
    ...
    updateCullingState() {
        ...
        const cullingState = getToolCullingState(points, this, options.line.extend, orientation);
        /**
...
class LineToolVerticalLine extends BaseLineTool {
    ...
    updateCullingState() {
         ...
         * The Y-coordinate (Price) is ignored for culling because the line spans all prices.
         */
        const cullingState = getToolCullingState(points, this, options.line.extend, { horizontal: false, vertical: true });
