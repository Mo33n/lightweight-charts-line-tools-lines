(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.LightweightChartsLineToolsLines = {}, global.LightweightCharts, global.LightweightChartsLineToolsCore));
     ...
     */
    class LineToolTrendLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
        ...
        _updateImpl(height, width) {
            ...
            const lineOptions = lightweightChartsLineToolsCore.deepCopy(options.line); // Cast to any for modification
            lineOptions.join = lineOptions.join || lightweightChartsLineToolsCore.LineJoin.Miter;
            lineOptions.cap = lineOptions.cap || lightweightChartsLineToolsCore.LineCap.Butt;
            /**
            ...
            if (options.text.value) {
                ...
                if (horizontalAlignment === lightweightChartsLineToolsCore.BoxHorizontalAlignment.Left.toLowerCase()) {
                    textLocationPoint = point0; // Attach to the first point of the line
                }
                else if (horizontalAlignment === lightweightChartsLineToolsCore.BoxHorizontalAlignment.Right.toLowerCase()) {
                    ...
                    textLocationPoint = new lightweightChartsLineToolsCore.AnchorPoint(lineMidpointX, lineMidpointY, 0);
                }
        ...
        _addAnchors(renderer) {
            ...
            const anchorData = {
                ...
                pointsCursorType: [lightweightChartsLineToolsCore.PaneCursorType.DiagonalNwSeResize, lightweightChartsLineToolsCore.PaneCursorType.DiagonalNwSeResize],
            };
     ...
     */
    class LineToolTrendLine extends lightweightChartsLineToolsCore.BaseLineTool {
        /**
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            const finalOptions = lightweightChartsLineToolsCore.deepCopy(TrendLineOptionDefaults);
        ...
        updateCullingState() {
             ...
             */
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this, options.line.extend);
            /**
    ...
    class LineToolExtendedLine extends LineToolTrendLine {
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(ExtendedLineSpecificOverrides));
    ...
    const ArrowSpecificOverrides = {
        line: {
            end: { right: lightweightChartsLineToolsCore.LineEnd.Arrow }, // Key change: Arrow end on the right side
        }
    };
    /**
    ...
    class LineToolArrow extends LineToolTrendLine {
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(ArrowSpecificOverrides));
            // 3. Merge the user's provided options last (User wins).
    ...
    class LineToolRay extends LineToolTrendLine {
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(RaySpecificOverrides));
            // 3. Merge the user's provided options last (User wins).
     ...
     */
    class LineToolHorizontalLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
        ...
        constructor(source, chart, series) {
             ...
             * @protected
             */
            this._lineRenderer = new lightweightChartsLineToolsCore.SegmentRenderer();
        }
        /**
        ...
        _updateImpl(height, width) {
            ...
            const leftPoint = new lightweightChartsLineToolsCore.AnchorPoint(finalStartX, lineY, 0);
            const rightPoint = new lightweightChartsLineToolsCore.AnchorPoint(finalEndX, lineY, 1);
            // --- Line Rendering ---
            const lineOptions = lightweightChartsLineToolsCore.deepCopy(options.line);
            lineOptions.join = lineOptions.join || lightweightChartsLineToolsCore.LineJoin.Miter;
            lineOptions.cap = lineOptions.cap || lightweightChartsLineToolsCore.LineCap.Butt;
            ...
            if (options.text.value) {
                ...
                switch (horizontalAlignment) {
                    case lightweightChartsLineToolsCore.BoxHorizontalAlignment.Left.toLowerCase():
                        textPivotX = minXBound;
                        break;
                    case lightweightChartsLineToolsCore.BoxHorizontalAlignment.Right.toLowerCase():
                        textPivotX = maxXBound;
                        break;
                    case lightweightChartsLineToolsCore.BoxHorizontalAlignment.Center.toLowerCase():
                    default:
                        textPivotX = (minXBound + segmentWidth / 2);
                        break;
                }
                const textPivot = new lightweightChartsLineToolsCore.AnchorPoint(textPivotX, anchorPoint.y, 0);
                const textRendererData = {
        ...
        _addAnchors(renderer) {
            ...
            const anchorData = {
                points: [anchorPoint],
                pointsCursorType: [lightweightChartsLineToolsCore.PaneCursorType.VerticalResize], // Vertical resize as it only moves in Price
            };
     ...
     */
    class LineToolHorizontalLine extends lightweightChartsLineToolsCore.BaseLineTool {
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(HorizontalLineSpecificOverrides));
            // 3. Merge the user's provided options last (User wins).
            lightweightChartsLineToolsCore.merge(finalOptions, options);
        ...
        updateCullingState() {
            ...
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this, options.line.extend, orientation);
            /**
    ...
    class LineToolHorizontalRay extends LineToolHorizontalLine {
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(HorizontalRaySpecificOverrides));
            // 3. Merge the user's provided options last (User wins).
            lightweightChartsLineToolsCore.merge(finalOptions, options);
     ...
     */
    class LineToolVerticalLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
         * Internal renderer for the optional text label.
         * @protected
         */
        ...
        _updateImpl(height, width) {
             ...
             */
            const pBottom = new lightweightChartsLineToolsCore.AnchorPoint(lineX, paneDrawingHeight, 0);
            const pTop = new lightweightChartsLineToolsCore.AnchorPoint(lineX, 0, 0);
            const compositeRenderer = new lightweightChartsLineToolsCore.CompositeRenderer();
            const lineOptions = lightweightChartsLineToolsCore.deepCopy(options.line);
            lineOptions.join = lineOptions.join || lightweightChartsLineToolsCore.LineJoin.Miter;
            lineOptions.cap = lineOptions.cap || lightweightChartsLineToolsCore.LineCap.Butt;
            ...
            if (options.text.value) {
                ...
                const textAttachmentPoint = new lightweightChartsLineToolsCore.AnchorPoint(lineX, textPivotY, 0);
                const textRendererData = {
        ...
        _addAnchors(renderer) {
            ...
            const anchorData = {
                points: [anchorPoint],
                pointsCursorType: [lightweightChartsLineToolsCore.PaneCursorType.HorizontalResize], // Suggest horizontal resize (ew-resize)
            };
            // Add the single LineAnchorRenderer set
            renderer.append(this.createLineAnchor(anchorData, 0));
        }
     ...
     */
    class LineToolVerticalLine extends lightweightChartsLineToolsCore.BaseLineTool {
        /**
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(VerticalLineSpecificOverrides));
            // 3. Merge the user's provided options last (User wins).
            lightweightChartsLineToolsCore.merge(finalOptions, options);
            // 4. Call the parent (BaseLineTool) constructor.
        ...
        updateCullingState() {
             ...
             * The Y-coordinate (Price) is ignored for culling because the line spans all prices.
             */
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this, options.line.extend, { horizontal: false, vertical: true });
     ...
     */
    class LineToolCrossLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
        ...
        constructor(source, chart, series) {
            ...
            this._horizontalRenderer = new lightweightChartsLineToolsCore.SegmentRenderer();
            this._verticalRenderer = new lightweightChartsLineToolsCore.SegmentRenderer();
        }
        /**
         * The core update logic.
         *
        ...
        _updateImpl(height, width) {
             ...
             * semantic 'right' = Top.
             */
            const vP0 = new lightweightChartsLineToolsCore.AnchorPoint(lineX, paneDrawingHeight, 0);
            const vP1 = new lightweightChartsLineToolsCore.AnchorPoint(lineX, 0, 0);
             ...
             */
            const hP0 = new lightweightChartsLineToolsCore.AnchorPoint(0, lineY, 0);
            const hP1 = new lightweightChartsLineToolsCore.AnchorPoint(paneDrawingWidth, lineY, 0);
        ...
        _addAnchors(renderer) {
            ...
            const anchorData = {
                points: [anchorPoint],
                pointsCursorType: [lightweightChartsLineToolsCore.PaneCursorType.Crosshair], // Suggest crosshair/move
            };
            // Add the single LineAnchorRenderer set
            renderer.append(this.createLineAnchor(anchorData, 0));
        }
    ...
    const CrossLineDefaultOptions = {
        visible: true,
        editable: true,
        defaultHoverCursor: lightweightChartsLineToolsCore.PaneCursorType.Crosshair,
        defaultDragCursor: lightweightChartsLineToolsCore.PaneCursorType.Crosshair,
        defaultAnchorHoverCursor: lightweightChartsLineToolsCore.PaneCursorType.Crosshair,
        defaultAnchorDragCursor: lightweightChartsLineToolsCore.PaneCursorType.Crosshair,
        notEditableCursor: lightweightChartsLineToolsCore.PaneCursorType.Crosshair,
        showPriceAxisLabels: true,
        showTimeAxisLabels: true,
        priceAxisLabelAlwaysVisible: true,
        timeAxisLabelAlwaysVisible: true,
     ...
     */
    class LineToolCrossLine extends lightweightChartsLineToolsCore.BaseLineTool {
        /**
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            const finalOptions = lightweightChartsLineToolsCore.deepCopy(CrossLineDefaultOptions);
     ...
     */
    class LineToolCalloutPaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
        ...
        _addAnchors(renderer) {
            ...
            const anchorData = {
                points: [point0, point1],
                pointsCursorType: [lightweightChartsLineToolsCore.PaneCursorType.Pointer, lightweightChartsLineToolsCore.PaneCursorType.Pointer],
            };
            renderer.append(this.createLineAnchor(anchorData, 0));
        }
    }
    ...
    const CalloutSpecificOverrides = {
        ...
        timeAxisLabelAlwaysVisible: false,
        line: {
            end: { left: lightweightChartsLineToolsCore.LineEnd.Normal, right: lightweightChartsLineToolsCore.LineEnd.Normal }, // Default to Normal ends
    ...
    class LineToolCallout extends LineToolTrendLine {
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            lightweightChartsLineToolsCore.merge(finalOptions, lightweightChartsLineToolsCore.deepCopy(CalloutSpecificOverrides));
            // 3. Merge the user's provided options last (User wins).
            lightweightChartsLineToolsCore.merge(finalOptions, options);
            // 4. Call the parent (LineToolTrendLine) constructor.
            super(coreApi, chart, series, horzScaleBehavior, finalOptions, points, priceAxisLabelStackingManager);
    ...
    exports.LineToolArrow = LineToolArrow;
    exports.LineToolCallout = LineToolCallout;
    exports.LineToolCrossLine = LineToolCrossLine;
    exports.LineToolExtendedLine = LineToolExtendedLine;
    exports.LineToolHorizontalLine = LineToolHorizontalLine;
    exports.LineToolHorizontalRay = LineToolHorizontalRay;
    exports.LineToolRay = LineToolRay;
    exports.LineToolTrendLine = LineToolTrendLine;
    exports.LineToolVerticalLine = LineToolVerticalLine;
    exports.default = registerLinesPlugin;
    exports.registerLinesPlugin = registerLinesPlugin;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=lightweight-charts-line-tools-lines.umd.js.map
